      ...
      <div className="container-content py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                { href: "/listings", label: "Car Listings" },
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {["News", "Events", "Spotlights", "Market Trends", "Buyer Guides", "GridLocal Picks"].map((cat) => (
                <li key={cat}>
                  <Link
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/grid.local" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-700 hover:bg-primary transition-colors flex items-center justify-center" aria-label="Instagram">
              ...
              {/* X/Twitter */}
              <a href="https://x.com/gridlocalmiami" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-700 hover:bg-primary transition-colors flex items-center justify-center" aria-label="X / Twitter">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              {/* YouTube */}
              <a href="#" className="w-9 h-9 rounded-lg bg-gray-700 hover:bg-primary transition-colors flex items-center justify-center" aria-label="YouTube">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
