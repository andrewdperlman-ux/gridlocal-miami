        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              {/* Instagram */}
              <a href="#" className="w-9 h-9 rounded-lg bg-gray-700 hover:bg-primary transition-colors flex items-center justify-center" aria-label="Instagram">
              ...
              {/* X/Twitter */}
              <a href="#" className="w-9 h-9 rounded-lg bg-gray-700 hover:bg-primary transition-colors flex items-center justify-center" aria-label="X / Twitter">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
